...
# Scenario 3
for i in {1..5}; do roslaunch --log floorplan-dsl-environments frontiers_scenarios.launch scenario:=scenario3.1 environment_name:=frontiers_brsu_building_c_adversarial route_file:=task_1 map_name:=brsu_building_c_dynamic robot_config:=$SCENARIO_CONFIG; done

for i in {1..5}; do roslaunch --log floorplan-dsl-environments frontiers_scenarios.launch scenario:=scenario3.2 environment_name:=frontiers_brsu_building_c_adversarial route_file:=task_2 map_name:=brsu_building_c_dynamic robot_config:=$SCENARIO_CONFIG; done

for i in {1..5}; do roslaunch --log floorplan-dsl-environments frontiers_scenarios.launch scenario:=scenario3.3 environment_name:=frontiers_brsu_building_c_adversarial route_file:=task_3 map_name:=brsu_building_c_dynamic robot_config:=$SCENARIO_CONFIG; done

for i in {1..5}; do roslaunch --log floorplan-dsl-environments frontiers_scenarios.launch scenario:=scenario3.4 environment_name:=frontiers_brsu_building_c_adversarial route_file:=task_4 map_name:=brsu_building_c_dynamic robot_config:=$SCENARIO_CONFIG; done
